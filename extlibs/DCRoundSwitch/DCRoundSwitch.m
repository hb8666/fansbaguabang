...
//	NSBundle *uiKitBundle = [NSBundle bundleWithIdentifier:@"com.apple.UIKit"];
	//self.onText = uiKitBundle ? [uiKitBundle localizedStringForKey:@"夜" value:nil table:nil] : @"夜";
	//self.offText = uiKitBundle ? [uiKitBundle localizedStringForKey:@"日" value:nil table:nil] : @"日";
	...
	toggleLayer = [[DCRoundSwitchToggleLayer alloc] initWithOnString:self.onText offString:self.offText onTintColor:[UIColor whiteColor]];
